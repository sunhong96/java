...
//        // int height = Integer.parseInt(sc.next()); // .next()메서드는 항상 String 타입 으로 반환함
//        int height = sc.nextInt(); //바로 인트형으로변환
...
//        System.out.println("몸무게 : " + weight);
        ...
        //String lang = sc.next(); //띄어쓰기를 구분해 답을 하나씩받음
        String lang = sc.nextLine(); // 한줄을 다받음
